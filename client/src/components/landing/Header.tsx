...
const NAV_ITEMS: NavItem[] = [
  ...
  { labelKey: "Queues", href: "/queues" },
  {
    ...
    href: "/accounts",
    menu: [
      { labelKey: "Make Payment", href: "/accounts/make-payment" },
      { labelKey: "PG Failure Queue", href: "/accounts/pg-failure-queue" },
      { labelKey: "Flight Credit Note", href: "/accounts/credit-notes/flight" },
      { labelKey: "Insurance Credit Note", href: "/accounts/credit-notes/insurance" },
      { labelKey: "Bus Credit Note", href: "/accounts/credit-notes/bus" },
      { labelKey: "Car Credit Note", href: "/accounts/credit-notes/car" },
      { labelKey: "Hotel Credit Note", href: "/accounts/credit-notes/hotel" },
      { labelKey: "Transfer Credit Note", href: "/accounts/credit-notes/transfer" },
      { labelKey: "Invoice History", href: "/accounts/invoice-history" },
      { labelKey: "Payment History", href: "/accounts/payment-history" },
      { labelKey: "View Accounts", href: "/accounts/view" },
      { labelKey: "Agency ITR Declaration", href: "/accounts/itr-declaration" },
      { labelKey: "Agency PAN Declaration", href: "/accounts/pan-declaration" },
      { labelKey: "Bank Account", href: "/accounts/bank-account" },
      { labelKey: "Spakstrp Bank Detail", href: "/accounts/bank-detail" },
      { labelKey: "Spakstrip GST Details", href: "/accounts/gst-details" },
    ],
  },
...
const MEGA_DESCRIPTIONS: Record<string, string> = {
  ...
  "Make Payment": "Deposit or settle outstanding balance",
  "PG Failure Queue": "Retry failed payment gateway transactions",
  "Flight Credit Note": "Credit notes issued for flight bookings",
  "Insurance Credit Note": "Insurance refund credit notes",
  "Bus Credit Note": "Credit notes for bus cancellations",
  "Car Credit Note": "Car rental credit notes",
  "Hotel Credit Note": "Hotel booking credit notes",
  "Transfer Credit Note": "Transfer booking credit notes",
  "Invoice History": "All past invoices at a glance",
  "Payment History": "Track all payment records",
  "View Accounts": "Account ledger and running balance",
  "Agency ITR Declaration": "File ITR declaration for your agency",
  "Agency PAN Declaration": "Submit agency PAN details",
  "Bank Account": "Manage linked bank accounts",
  "Spakstrp Bank Detail": "Spakstrip banking information",
  "Spakstrip GST Details": "GST registration and tax information",
